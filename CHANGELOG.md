...
## [0.1.3](https://github.com/IohannRabeson/tmignore-rs/releases/tag/v0.1.3) - 2026-03-17

### Fixed

- Also print error on stderr to print the error even if the logger failed to initialize.
